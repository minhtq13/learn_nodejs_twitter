...
const sendVerifyEmailTemplate = fs.readFileSync(path.resolve("src/templates/verify-email.html"), "utf-8");
...
export const sendVerifyRegisterEmail = (
  ...
  template: string = sendVerifyEmailTemplate,
) => {
...
export const sendForgotPasswordEmail = (
  ...
  return sendVerifyEmail(
    ...
    "Forgot password",
    template
      .replace("{{title}}", "You recently requested to reset your password")
