export const USERS_MESSAGES = {
  ...
  USERNAME_INVALID: "Username must be 4-15 characters long and can contain only letters, numbers underscores and not only numbers",
...
export const TWEET_MESSAGES = {
  ...
  PAREN_ID_MUST_BE_NULL: "Parent id must be null",
...
export const BOOKMARK_MESSAGES = {
  BOOKMARK_TWEET_SUCCESSFULLY: "Bookmark successfully!",
  UNBOOKMARK_TWEET_SUCCESSFULLY: "Unbookmark tweet successfully!",
}

export const LIKE_MESSAGES = {
  LIKE_TWEET_SUCCESSFULLY: "Like successfully!",
